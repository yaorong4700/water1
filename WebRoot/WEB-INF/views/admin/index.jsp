...
<html>
	...
	<body style="overflow:auto">
		<div class="main_header">
			...
			<font id="index_string_title" style="font-size:29px;color: #EEF2FB;">&nbsp;HSCNCLOUD</font>
			</div>
			</a>
		...
		<div class="main_content">
			<div class="content_left">
				<h1>
					<a><label>MENU</label></a>
				</h1>
				<div class="menu_line">
					<ul>
						<li>
                            <a id="water_string_menu_1" href ="regionSum.do" target="mainFrame">代码构建</a>
                        </li>
                        <li>
                            <a id="water_string_menu_2" href ="regionPic.do" target="mainFrame">镜像仓库</a>
                        </li>
                        <li>
                            <a id="water_string_menu_3" href ="regionSum.do" target="mainFrame">服务集成</a>
                        </li>
                        <li>
                            <a id="water_string_menu_4" href ="developDepartment.do" target="mainFrame">我的项目</a>
                        </li>
					</ul>					
				</div>
			</div>
					...
					<tr
						...
						<td style="height: 29px; line-height: 29px;">
							<div class="content_title">
								<label id="index_string_pagename">INFO</label>
							</div>
						</td>
						<td
